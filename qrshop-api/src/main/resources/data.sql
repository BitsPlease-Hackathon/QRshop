INSERT INTO users (id, username, password, email, first_name, last_name, role, enabled) VALUES ('1111-1111-1111', 'admin', 'admin', 'perastath@gmail.com', 'Periklis', 'Astathopoulos', 'ROLE_SUPER', true);
